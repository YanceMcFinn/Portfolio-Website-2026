export default function About() {
    return (
         <div className = "flex w-full ml-0 justify-between px-0 dark:text-white bg-[url(images/assets/Me2.png)] bg-contain h-[calc(100vh-64px)]">
            {/*<img
          src="images/assets/Me2.png" className="max-h-[calc(100vh-64px)] max-w-1/2 md:max-w-full"></img>*/}
