export default function About() {
    return (
         <div className = "flex flex-col md:flex-row w-full ml-0 justify-between px-0 dark:text-white">
            <img
          ...
          md:w-1/2"></img>
            <div className = "my-auto mx-5 md:mx-20">
                <h1 className="text-2xl md:text-4xl font-semibold mt-3 mb-6">ABOUT</h1>
