...
<section className="relative w-full h-[400px] md:h-[600px] bg-black text-white overflow-hidden">
    ...
    <div className="flex justify-center items-center">
      <div className="flex bg-black text-white justify-center items-center w-full py-10">
        <i className="fa-solid fa-globe fa-2xl text-lime-400"></i>
        <div className="flex "> 
          <h1 className="text-2xl md:text-4xl text-lime-400 mx-5 self-center">WEB DESIGN</h1>
          <p className="text-xl my-auto ml-4">Fast and responsive frontend development for eye-catching,<br/> user-friendly website and app experiences</p>
        </div>
      </div>
    </div>
    <hr className="border-white border-1"/>
    ...
    <div className="flex justify-center">
      <div className="flex bg-black text-white justify-center items-center w-full py-10">
        ...
        <div className="flex "> 
          <h1 className="text-4xl text-lime-400 mx-5 self-center">MOTION GRAPHICS</h1>
          <p className="text-base md:text-xl my-auto ml-4">Fast and responsive frontend development for eye-catching,<br/> user-friendly website and app experiences</p>
        </div>
      </div>
    </div>
