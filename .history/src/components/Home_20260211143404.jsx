...
<section className="relative bg-black text-white flex items-center">
      <div className="w-full grid md:grid-cols-2">
        ...
        {/* LEFT SIDE - TEXT */}
        <div className="ml-10 my-auto items-center md:items-start
          ...
          <div className="mt-8 flex flex-row gap-4 items-center md:items-start">
            <Link
              to="/portfolio"
        ...
        <div className="relative pr-0 h-[400px] md:h-[600px] w-full">
          <img
            ...
            alt="Design showcase"
            className="absolute inset-0 w-full h-full object-cover grayscale mask-l-from-50% mask-l-to-90% hidden md:block"
          />
        </div>
