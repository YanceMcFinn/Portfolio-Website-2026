...
<section className="relative w-full h-[400px] md:h-[600px] bg-black text-white overflow-hidden">
      ...
      <div className="flex bg-black text-white justify-center items-center w-full py-10">
        <img src="images/assets/balazs-ketyi-LPWl2pEVGKc-unsplash.jpg" className="rounded-full flex-1 border-3 border-lime-400 h-50 md:h-80 w-50 md:w-80"></img>
        <div className="flex flex-2 flex-col md:flex-row text-left md:text-center"> 
          <h1 className="text-3xl lg:text-4xl text-lime-400">GRAPHIC DESIGN</h1>
          <p className="md:ml-5 text-l md:text-xl my-auto md">From logos to apparel, and everything in between!</p>
        </div>
      </div>
    </div>
       ...
       <div className="flex justify-center px-6 bg-black">
      <div className="flex bg-black text-white justify-center items-center w-full py-10">
        <i className="fa-solid fa-paintbrush fa-4x md:fa-2x text-lime-400 mx-5"></i>
        <div className="flex flex-col md:flex-row text-left md:text-center"> 
          <h1 className="text-3xl lg:text-4xl text-lime-400">GRAPHIC DESIGN</h1>
          <p className="md:ml-5 text-l md:text-xl my-auto md">From logos to apparel, and everything in between!</p>
        </div>
      </div>
    ...
    <div className="flex justify-center px-6 bg-black">
      <div className="flex bg-black text-white justify-center items-center w-full py-10">
        <i className="fa-solid fa-globe fa-4x md:fa-2x text-lime-400 mx-5"></i>
        <div className="flex flex-col md:flex-row text-left md:text-center"> 
          <h1 className="text-3xl lg:text-4xl text-lime-400">WEB DESIGN</h1>
          <p className="md:ml-5 text-l md:text-xl my-auto md">Fast and responsive frontend development for eye-catching, user-friendly website and app experiences</p>
        </div>
      </div>
    </div>
    <hr className="border-white border-1"/>
    ...
    <div className="flex justify-center px-6 bg-black">
      <div className="flex bg-black text-white justify-center items-center w-full py-10">
        <i className="fa-solid fa-circle-play fa-4x md:fa-2x text-lime-400 mx-5"></i>
        <div className="flex flex-col md:flex-row text-left md:text-center"> 
          <h1 className="text-3xl lg:text-4xl text-lime-400">MOTION GRAPHICS</h1>
          <p className="md:ml-5 text-l md:text-xl my-auto md">Custom animated graphics for advertisement and social media</p>
        </div>
      </div>
    </div>
