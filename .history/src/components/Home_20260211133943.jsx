export default function Home (){
    return (
        <div>
            <div className="flex mt-10 mx-10 bg-black text-white items-center justify-between
 h-[600px] spa">
                <div>
                    <div className="justify-self-center px-10">
                        ...
                        <div className="flex mt-5">
                            <button className="bg-black border-white border 1 text-white rounded-2xl p-3">View my portfolio</button>
                        </div>
                    </div>
                </div>
