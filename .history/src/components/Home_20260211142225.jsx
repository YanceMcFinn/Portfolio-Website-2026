...
<section className="relative bg-black text-white flex items-center">
      <div className="container mx-auto grid md:grid-cols-2 items-stretch gap-12">
        ...
        <div className="relative pr-0 h-[400px] md:h-[600px] w-full">
          <img
            ...
            alt="Design showcase"
            className="absolute inset-0 w-full h-full object-cover grayscale mask-l-from-50% mask-l-to-90%"
          />
        </div>
