export default function About() {
    return (
         <div className = "sm:flex-col md:flex-row w-full ml-0 justify-between px-0 dark:text-white">
            <div className="max-w-1/2"><img
          src="images/assets/Me2.png" className="max-h-[calc(100vh-64px)] max-w-1/2 md:max-w-full"></img></div>
