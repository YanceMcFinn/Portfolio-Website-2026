...
<section className="relative w-full h-[400px] md:h-[600px] bg-black text-white overflow-hidden">
    ...
    <div className="justify-center">
      <div className="flex bg-black text-white justify-between items-center w-full px-90 py-10">
        <i className="fa-solid fa-paintbrush fa-2xl"></i>
        <div className="flex "> 
          <h1 className="text-4xl">GRAPHIC DESIGN</h1>
          <p className="mx-5 text-3xl">|</p>
          <p className="text-4xl">From logos to apparel, and everything in between!</p>
        </div>
      </div>
    </div>
